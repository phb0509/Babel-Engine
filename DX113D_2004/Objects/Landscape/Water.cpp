...
Water::Water(float radius) : radius(radius)
{
...
void Water::PostRender()
{
	...
	ImGui::SliderFloat("WaveAlpha", &buffer->data.alpha, 0.0f, 1.0f);
	ImGui::SliderFloat("WaveShininess", &buffer->data.shininess, 0.0f, 50.0f);
}
