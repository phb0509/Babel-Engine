...
namespace ImGui
{
    ...
    IMGUI_API void                  TableSetBgColor(ImGuiTableBgTarget mTargetObject, ImU32 color, int column_n = -1);  // change the color of a cell, row, or column. See ImGuiTableBgTarget_ flags for details.
