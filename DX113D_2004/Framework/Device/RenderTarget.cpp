...
void RenderTarget::ClearAndSetWithDSV(RenderTarget** targets, UINT count, DepthStencil* depthStencil)
{
...
void RenderTarget::ClearAndSetWithoutDSV(RenderTarget** targets, UINT count)
{
	vector<ID3D11RenderTargetView*> rtvs;
